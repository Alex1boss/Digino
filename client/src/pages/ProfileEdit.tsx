            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
              ...
              <div className="lg:col-span-1">
                <div className="sticky top-8 space-y-6">
                  <div className="bg-[#1A1A3A] rounded-lg p-6 space-y-6 border border-white/10">
                    <div className="flex flex-col items-center text-center">
                      <div className="relative group">
                        <div className="w-24 h-24 bg-gradient-to-br from-[#0056D2] to-[#00C49A] rounded-full flex items-center justify-center text-white text-3xl font-bold overflow-hidden">
                          {previewImage ? (
                            <img 
                              src={previewImage} 
                              alt="Profile" 
                            ...
                            <span>{form.watch("fullName")?.[0] || "A"}</span>
                          )}
                          <div className="absolute bottom-0 right-0 bg-[#0056D2] p-1 rounded-full border-2 border-[#1A1A3A]">
                            <div className="bg-[#1A1A3A] rounded-full p-0.5">
                      ...
                      <div className="flex flex-wrap gap-2 mt-4 justify-center">
                        <div className="bg-[#0A0A23] px-3 py-1.5 rounded-lg border border-[#0056D2]/30 text-sm font-medium text-white flex items-center gap-1.5">
                          <User size={14} className="text-[#0056D2]" />
                          Edit Mode
                        </div>
                      </div>
              ...
              <div className="lg:col-span-3">
                <Tabs 
                  ...
                  className="w-full"
                >
                  <div className="bg-[#1A1A3A] rounded-lg overflow-hidden border border-white/10">
                            ...
                            <FormField
                              ...
                              render={({ field }) => (
                                <FormItem>
                                  ...
                                  <FormControl>
                                    <div className="relative">
                                      <Twitter size={16} className="absolute left-3 top-1/2 transform -translate-y-1/2 text-white/50" />
                                      <Input 
                            ...
                            <FormField
                              ...
                              render={({ field }) => (
                                <FormItem>
                                  ...
                                  <FormControl>
                                    <div className="relative">
                                      <Instagram size={16} className="absolute left-3 top-1/2 transform -translate-y-1/2 text-white/50" />
                                      <Input 
                                        placeholder="username" 
                                        {...field} 
                                        className="bg-white/5 border-white/10 focus-visible:ring-[#0056D2] text-white pl-10"
                            ...
                            <FormField
                              ...
                              render={({ field }) => (
                                <FormItem>
                                  ...
                                  <FormControl>
                                    <div className="relative">
                                      <Github size={16} className="absolute left-3 top-1/2 transform -translate-y-1/2 text-white/50" />
                                      <Input 
                                        placeholder="username" 
                                        {...field} 
                                        className="bg-white/5 border-white/10 focus-visible:ring-[#0056D2] text-white pl-10"
